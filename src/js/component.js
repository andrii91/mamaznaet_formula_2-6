...
$(function () {
  ...
  var note = $('#note'),
    ts = new Date(2019, 04, 24, 23, 59), //new Date(year, month, date, hours, minutes, seconds, ms)
    // ts =dateEnd,
...
$(document).ready(function () {
  ...
  $('form').on('submit', function(e) {
          ...
          var email_tl = $form.find('input[name="email"]').val();
          var phone_tl = $form.find('input[name="phone"]').val();

          $.ajax({
            type: 'POST',
            url: 'https://api.telegram.org/bot801507460:AAGfGGyQTSPSy0ai-rZyFpIaJcjl1AbObKU/sendMessage?chat_id=308548437&text=Новый лид c Формула Воспитания 2-6 лет: ' 
            + name_tl + ' | ' + email_tl + ' | ' + phone_tl,
          });

          $.ajax({
            type: 'POST',
            url: 'https://api.telegram.org/bot801507460:AAGfGGyQTSPSy0ai-rZyFpIaJcjl1AbObKU/sendMessage?chat_id=268845099&text=Новый лид c Формула Воспитания 2-6 лет: ' 
            + name_tl + ' | ' + email_tl + ' | ' + phone_tl,
          });

          $.ajax({
            type: 'POST',
            url: 'https://api.telegram.org/bot801507460:AAGfGGyQTSPSy0ai-rZyFpIaJcjl1AbObKU/sendMessage?chat_id=266439197&text=Новый лид c Формула Воспитания 2-6 лет: ' 
            + name_tl + ' | ' + email_tl + ' | ' + phone_tl,
          });
